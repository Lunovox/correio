...
minetest.register_chatcommand("correio", {
	...
	func = function(name, param)
		...
		minetest.chat_send_player(name, "############################################################################################", false)
		minetest.chat_send_player(name, "### lunocartas                                                                            ###", false)
		...
		minetest.chat_send_player(name, "   * /broadcast <Mensagem>", false)
		...
		minetest.chat_send_player(name, "   * /mail <NomeDoJogador> <Mensagem>", false)
